...
WEBDRIVER = dict(
    ...
    user_agent="Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36",  # 字符串 或 无参函数，返回值为user_agent
...
# 设置代理
# 代理提取API ，返回的代理分割符为\r\n
PROXY_EXTRACT_API = "http://http.tiqu.letecs.com/getip3?num=10&type=1&pro=&city=0&yys=0&port=11&time=1&ts=0&ys=0&cs=0&lb=1&sb=0&pb=4&mr=1&regions=&gm=4"
PROXY_ENABLE = False
#
# # 随机headers
# RANDOM_HEADERS = True
...
# 验证码
CAPTCHA_PATH = "./images/"
CAPTCHA_REDIS_KEY = "maoyan:captcha"
CAPTCHA_BLOCK_IP_REDIS_KEY = "maoyan:captcha_block_ip"
